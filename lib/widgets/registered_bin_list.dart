...
class RegisteredListBin extends StatelessWidget {
  /* const AssignedCardHeader({Key? key, required this.listaGuiasAsignadas})
      : super(key: key);
  final AssiggrListProvider listaGuiasAsignadas; */
  const RegisteredListBin({Key? key, required this.listaGuiasBinAsignadas})
      : super(key: key);
  final RegisteredBinGuiasProvider listaGuiasBinAsignadas;
  @override
  Widget build(BuildContext context) {
    /* final listaGuiaBin = Provider.of<AssiggrListProvider>(context); */
    return Expanded(
        child: ListView.builder(
            itemCount: listaGuiasBinAsignadas.binAsignadosReg.length,
            itemBuilder: (_, indice) => Container(
                  ...
                  child: Container(
                    ...
                    child: ListTile(
                      ...
                      title: Text(
                        'BIN # ${listaGuiasBinAsignadas.binAsignadosReg[indice].nrobin}',
                        /* 'BIN # 16', */
                      ...
                      subtitle: Text(
                          listaGuiasBinAsignadas
                              .binAsignadosReg[indice].fechahoraesc
                              .toString(),
                          /* '#Guia 145', */
                          style: const TextStyle(
                        ...
                        children: [
                          ...
                          IconButton(
                              ...
                              icon: Icon(
                                ...
                                listaGuiasBinAsignadas.binAsignadosReg[indice]
                                            .sincronizado ==
                                        1
                                    ? Icons.cloud_done
                                    : Icons.cloud_off,
                          ...
                          /* IconButton(
                              onPressed: () {
                                /* if (listaGuiasBinAsignadas
                                        .binAsignadosReg[indice].sincronizado ==
                                    0) {
