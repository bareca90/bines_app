...
class SalidaGranjaCMP extends StatelessWidget {
  const SalidaGranjaCMP({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    const String cedula = '1234567890';
    const String tipo = 'GUIASALGRA'; //Obtener Guías Llegadas a Camaroneras
    ...
    return Scaffold(
      body: Scaffold(
        appBar: AppBar(
          title: const Text('Salida Granja'),
          actions: [
            IconButton(
                onPressed: () {
                  showSearch(
              ...
              TextButton(
                  onPressed: () {
                    ...
                    Provider.of<DataGuiaBinServices>(context, listen: false)
                        .insertGuiaProcesada(
                            nroguia, 'RGUIASAGRA', tipo, cedula);
