...
class MovilListoCMP extends StatelessWidget {
  const MovilListoCMP({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    const String cedula = '1234567890';
    const String tipo = 'GMOVILLIST'; //Obtener Guías Llegadas a Camaroneras
              ...
              TextButton(
                  onPressed: () {
                    ...
                    Provider.of<DataGuiaBinServices>(context, listen: false)
                        .insertGuiaProcesada(
                            nroguia, 'RMOVILLIST', tipo, cedula);
